...
def startTest(request):    
    ...
    try:
        ...
        test = Test.objects.create(app_no=user_application, test_start=datetime.datetime.now())
...
def EndTest(request):
    ...
    test.score=score
    test.test_end=datetime.datetime.now()
    test.save()
    
    context = {'score':score, 'total': total}
    return render(request, 'endtest.html', context=context)