...
const element = window.matchMedia("(max-width: 700px)");
element.addEventListener("change", myFunction1);

function myFunction1(x) {
    if (x.matches) { // If media query matches
        document.getElementById("student-info-sd").style.display = "flex";
        document.getElementById("student-info-sd").style.flexDirection = "column";
      } else {
        document.getElementById("student-info-sd").style.display = "flex";
        document.getElementById("student-info-sd").style.flexDirection = "row";
      }
}
